...
// ADD YOUR CODE HERE
        dotArray = new DotInfo [size][size];
        for (int i = 0; i < size; i++){
            for (int k = 0; k < size; k++){
                dotArray[i][k] = new DotInfo(i, k, generator.nextInt(NUMBER_OF_COLORS));
        ...
        dotArray[0][0].setCaptured(true);
        currentSelectedColor = dotArray[0][0].getColor();
...
// ADD YOUR CODE HERE
        return dotArray[i][j].isCaptured();
